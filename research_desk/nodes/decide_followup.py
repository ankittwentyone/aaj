...
def decide_followup(state: dict) -> dict:
    ...
    if not os.environ.get("DEEPSEEK_API_KEY"):
        trace.append(trace_entry("decide_followup", "skipped", started_at=started, finished_at=now(), reason="no DEEPSEEK_API_KEY"))
    ...
    prompt = (
        ...
        'the leading catalyst, or null if news already suffices. No other text.\n\n'
    ...
    for _ in range(2):  # parse retry <= 2
        try:
            ...
            llm = deepseek_client("decide_followup")
